    ...
    public void run() {
        ...
        while (endPos > startPos && !isDownloadOver) {
            ...
            try {
                ...
                log.debug("开始 " + threadId + "：" + property + endPos);
                ...
                log.debug("#start#Thread: " + threadId + ", startPos: " + startPos + ", endPos: " + endPos);
                ...
                log.debug("#over#Thread: " + threadId + ", startPos: " + startPos + ", endPos: " + endPos);

                log.debug("Thread " + threadId + " is execute over!");
        ...
        if (endPos < startPos && !isDownloadOver) {
        	...
        	log.debug("Thread " + threadId  + " startPos > endPos, not need download file !");
    ...
    public static void printHeader(URLConnection conn) {
        ...
        while (true) {
            ...
            if (header != null) {
            	...
            	log.debug(header + ":" + conn.getHeaderField(i));
