	...
	<body class="bg_grey">
		...
		<div class="midd_wrap bg_white">
			<div class="deliveryNotifyDetail_top posR mr10">
				<div class="sale_right_title"><span>交期通知详情</span></div>
				<ul class="tab posA">
					<li>显示方式：</li>
				...
				<div class="notifyInfoByOrder">
					...
					<div class="right f_l">
						...
						<div class="mt10 mr20 operates">
							<button class="confirm f_r  ml10" onClick="confirmDeliveryTime(this,{{= it.orderDeliveryNotice.delivery_notice_id}})">确认</button>
