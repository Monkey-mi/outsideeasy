...
<link rel="stylesheet" href="/newresources/css/jquery.mCustomScrollbar.css" type="text/css" />
</head>
<body class="bg_grey">
<div id="top"></div>
<!--中间-->
	...
	<div class="midd_right_wrap" style="width:834px">
		...
		<div class="clearfix titleWithChangedRecord">
			...
			<div id="base_info" class="supplier_baseInfo tabcon2" style="display:block;">
				...
				<div id="company_licenses" class="buslicense_wrap mb20 clearfix ml20">
			...
			<div class="supplier_trade tabcon2">
				<div class="t_algin_r mt10"><button id="infoEdit" class="infoEdit" onclick="showEdit(this,3)">编辑</button><button id="infoCancel" class="infoEdit hide" onclick="editCancel(this)">取消</button><button id="infoSave" class="infoSave ml10 hide" onclick="editSave(this,3)">保存</button></div>
<!-- 				<div class="ml10 b mt30"><span class="title_split">||</span>&nbsp;&nbsp;银行信息</div> -->
				<div class="clearfix ml20 item">
					<div class="tradeInfoTitle">银行信息<span class="asterisk">*</span></div>
					<table id="bankTable" class="supplierInfo_table_list f_l item">	
<!-- 						 <tr> -->
...
<!-- 						</tr> -->
					...
					<div class="info_explain ml110 f_l"><img src="/vip/resources/images/applyAccess/er.png" class="mr10">银行信息不可为空</div>
				</div>
<!-- 				<div class="ml10 mt30 b"><span class="title_split">||</span>&nbsp;&nbsp;发票信息</div> -->
				<div class="clearfix ml20 item">
					<div class="tradeInfoTitle">发票信息</div>
					<table id="invoiceTable" class="supplierInfo_table_list f_l item">	
						<!--<tr>
							<th>发票抬头</th>
						</tr>
						 <tr >
					...
					<div class="info_explain ml110 f_l"><img src="/vip/resources/images/applyAccess/er.png" class="mr10">请填写发票信息</div>
				</div>
<!-- 				<div class="t_algin_r"> -->
